...
//Electrodomestico también deben afectar al precio.
    ...
    public Televisor(Integer precio, String color, String consumoenergetico, Integer peso,Integer pulgadas,boolean sintonizador) {
    ...
    super.crearElectrodomestico();
        ...
        System.out.println("Por favor ingrese las pulgadas del televisor");
        
        pulgadas = leer.nextInt();
        
        System.out.println("Por favor sintonice el televisor");
        
        sintonizador = leer.nextBoolean();
        
    }
    
   @Override public void precioFinal() {
   ...
   if(pulgadas>=40 && sintonizador ==true){
