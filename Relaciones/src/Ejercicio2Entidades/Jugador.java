...
public class Jugador {
    ...
    Revolver r = new Revolver();
     ...
     //En este método con mi objeto por parámetros r llamé a mis métodos
    //mojar y siguiente chorro. Mojado vendría a ser mi atributo, que en este
    //caso se lo puede usar directamente porque pertenece a la clase donde estamos
    //trabajando. De otra forma se necesitaría usar getter.
    //Y en el caso del if significa que si el jugador aprieta el gatillo y este no
    //dispara agua va a pasar al siguiente chorro.
