...
package Ejercicio2Principal;

import Ejercicio2Entidades.Electrodomestico;
import Ejercicio2Entidades.Lavadora;
import Ejercicio2Entidades.Televisor;
...
//electrodomésticos, 2000 para lavadora y 5000 para televisor
    ...
    televisor1.crearTelevisor();
      ...
      electrodomesticos.add(new Lavadora(10,1500,"rojo","G",20));
        ...
        for (Electrodomestico aux : electrodomesticos) {
            ...
            if (aux instanceof Lavadora ){
               ...
               contadorlav=contadorlav+lavadora.getPrecio();
            ...
            if(aux instanceof Televisor){
               ...
               contadortel+= televisor.getPrecio();
        ...
        contadorelec = contadorlav + contadortel;
        
        System.out.println("El precio total de las lavadoras es " + contadorlav);
        System.out.println("El precio total de los televisores es " + contadortel);
        System.out.println("El precio total de los electrodomésticos es " + contadorelec);
