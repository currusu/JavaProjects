package Ejercico2Principal;

import Ejercicio2Entidades.Juego;
import Ejercicio2Entidades.Jugador;
import Ejercicio2Entidades.Revolver;
import java.util.ArrayList;
import java.util.Scanner;


public class Ejercicio2RuletaAgua {
...
//Pensar la lógica necesaria para realizar esto, usando los atributos de la clase Juego.
    ...
    public static void main(String[] args) {
        ...
        //Acá declaré e instancié mis clases con sus 
        //respectivos objetos
        ...
        //Acá pedí al usuario que ingrese un número de jugadores
        
        System.out.println("Por favor ingrese cantidad de jugadores ");
        
        int cantidadjugadores = leer.nextInt();
        
        //Con este For agrego los jugadores ingresados por el
        //usuario. Mi variable j va a ser la que conecta el 
        //main con mi clase Jugador donde se encuentra el ArrayList.
        //Después en la lista jugadores voy a guardar mi Arraylist a través de mi
        //objeto j.
        ...
        System.out.println("Por favor apriete el gatillo");
